...
export const AboutPage: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 pb-16 animate-in fade-in duration-300">
      ...
      {/* Featured Aesthetic Canvas Image */}
      <div className="relative rounded-3xl overflow-hidden border border-[#E8E2D8] aspect-[21/9] shadow-lg">
        <img
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#1C1B1A]/70 via-transparent to-transparent flex items-end p-8 text-white">
